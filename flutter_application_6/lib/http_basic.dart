...
void editUser(List<User> users, int userId, String newUsername, String newPassword, String newUuid, Function updateUI) {
...
class _HttpBasicState extends State<HttpBasic> {
  ...
  void _openEditModal(User user) {
    ...
    final TextEditingController uuidController = TextEditingController(text: user.uuid);
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                _openEditModal(user); // เปิด Modal เพื่อแก้ไขข้อมูล
                              },
                            ),
                            // ปุ่ม Delete
                            IconButton(
